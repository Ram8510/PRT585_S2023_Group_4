...
namespace _1CommonInfrastructure.Services
{
    public class LoggingService : ILoggingService
    {
        ...
        {
            var connectionString = "data source=HARASHEXE\\SQLEXPRESS02;initial catalog=testdb27Sep22;integrated security=True;MultipleActiveResultSets=True;TrustServerCertificate=True;";//_configuration.GetSection("ConnectionStrings:ApplicationDB");                    
